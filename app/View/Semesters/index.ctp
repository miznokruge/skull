<div class="semesters index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('tahun'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($semester['Semester']['kode']); ?>&nbsp;</td>
		<td><?php echo h($semester['Semester']['tahun']); ?>&nbsp;</td>
		<td><?php echo h($semester['Semester']['semester']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $semester['Semester']['id']), array(), __('Are you sure you want to delete # %s?', $semester['Semester']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
